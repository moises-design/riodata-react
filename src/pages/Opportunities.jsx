...
const DEMO = [
    ...
    { id: 2, title: 'Pharr-Reynosa Bridge Expansion', sector: 'Government', budget: '$85M', location: 'Pharr, TX', status: 'Open', description: 'TxDOT project seeking general contractors for bridge widening and customs plaza expansion at Pharr-Reynosa International Bridge.', tags: ['General Contractor','Concrete','Steel'] },
    ...
    { id: 6, title: 'Reynosa Industrial Park Expansion', sector: 'Manufacturing', budget: '$65M', location: 'Reynosa, TAM', status: 'Open', description: 'New maquiladora industrial park expansion in Reynosa seeking construction and infrastructure contractors on both sides of the border.', tags: ['Site Development','Construction','Utilities'] },
