                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-16">
                    <div>
                        ...
                        <p className="text-sm text-[#5C5C54] leading-relaxed mb-4">
                            South Texas and Northern Mexico form one of the most dynamic trade corridors on Earth. $370 billion a year moves through here, yet the businesses, workforce, and institutions that make it happen have no shared platform to connect, grow, and compete.
                        </p>
                        <p className="text-sm text-[#5C5C54] leading-relaxed mb-4">
                            Companies in Reynosa can't find contractors across the bridge. Universities don't know what certifications employers actually need. EDCs pitch investors without real-time data. Projects worth hundreds of millions go to outside companies because local businesses aren't visible.
                        </p>
